...
class QubinoShutterDevice extends QubinoDevice {
  ...
  customSaveMessage(oldSettings, newSettings, changedKeys = []) {
    if (changedKeys.includes(SETTINGS.OPERATING_MODE)) {
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    ...
    if (changedKeys.includes(SETTINGS.INVERT_WINDOW_COVERINGS_TILT_DIRECTION)
    ...
    if (changedKeys.includes(SETTINGS.INVERT_WINDOW_COVERINGS_DIRECTION)
