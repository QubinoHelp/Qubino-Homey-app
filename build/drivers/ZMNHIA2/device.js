...
class ZMNHIA extends QubinoThermostatDevice {
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    // If enabled/disabled
    if (changedKeys.includes(SETTINGS.SETPOINT_INPUT_2_ENABLED)) {
      ...
      if (!(SETTINGS.SETPOINT_INPUT_2 in changedKeys)) changedKeys.push(SETTINGS.SETPOINT_INPUT_2);
      newSettings[SETTINGS.SETPOINT_INPUT_2] = setpointInput2Value;
    }

    // If enabled/disabled
    if (changedKeys.includes(SETTINGS.SETPOINT_INPUT_3_ENABLED)) {
      ...
      if (!(SETTINGS.SETPOINT_INPUT_3 in changedKeys)) changedKeys.push(SETTINGS.SETPOINT_INPUT_3);
